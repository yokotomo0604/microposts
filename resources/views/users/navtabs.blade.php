<ul class="nav nav-tabs nav-justified mb-3">
    ...
    <li class="nav-item"><a href="{{ route('users.follwers',['id' => $user->id]) }}" class="nav-link {{ Request::is('users/*/follwers') ? 'active' : '' }}">Followers<span class="badge badge-secondary">{{ $count_followers }}</span></a></li>
</ul>